...
if __name__ == "__main__":
	BASE_URL = "http://10.208.68.61:6003/v1/"

	base_model="Qwen3-06b"
	...
	MODELS = ["d_drgrpo_nfc","cp_mol_drgrpo_nfc","ce_nfc","ce_nfc_grpo"]
	for MODEL_NAME in MODELS:
		print(MODEL_NAME + " is processing")
		API_KEY = "10295152"
	...
	MODELS = ["d_drgrpo_sci","cp_mol_drgrpo_sci","ce_sci","ce_sci_grpo"]
	for MODEL_NAME in MODELS:
		print(MODEL_NAME + " is processing")
		API_KEY = "10295152"
